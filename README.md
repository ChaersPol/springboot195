...
## 本项目获取地址：https://www.bishecode.com/product/192/
...
图5.2  就业管理页面【项目管理页面提供的功能操作有：查看就业，删除就业操作，新增就业操作，修改就业操作。下图就是就业管理页面。】
![alt text](images/image-2.png)

图5.3 企业公告信息管理页面【企业公告信息管理页面提供的功能操作有：新增企业公告，修改企业公告，删除企业公告操作。下图就是企业公告信息管理页面。】
![alt text](images/image-3.png)

图5.4 企业公告类型列表页面【企业公告类型管理页面显示所有企业公告类型，在此页面既可以让管理员添加新的企业公告信息类型，也能对已有的企业公告类型信息执行编辑更新，失效的企业公告类型信息也能让管理员快速删除。下图就是企业公告类型管理页面。】
